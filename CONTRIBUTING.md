...
This repository is the onboarding project for first-time Manifesto users.
...
- Follow the onboarding steps in [`START_HERE.md`](START_HERE.md) for new experiments.
...
- [ ] Relevant docs updated (`CONTRIBUTING.md`, `START_HERE.md`, etc.)
